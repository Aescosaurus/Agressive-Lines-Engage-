...
namespace Colors
{
	...
	static constexpr Color Pink = MakeRGB( 255u,0u,128u );
	static constexpr Color LightBlue = MakeRGB( 91u,132u,246u );
	static constexpr Color RedOrange = MakeRGB( 255u,69u,10u );
}